...
class DaysList extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: StickyGroupedListView<DayAppointmentsModel, DateTime>(
        elements: controller.daysList,
        order: StickyGroupedListOrder.ASC,
        itemScrollController: controller.groupedItemScrollController,
        groupBy: (DayAppointmentsModel element) =>
        ...
        indexedItemBuilder: (_, DayAppointmentsModel dayAppointment, index) =>
            DayAppointments(
